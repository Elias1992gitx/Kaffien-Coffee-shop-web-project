# Kaffien Coffee Shop Web Project

A web-based coffee shop application built using JavaScript, HTML, CSS, PHP, and MySQL database.
...
git clone https://github.com/Elias1992gitx/kaffien-coffee-shop-web-project.git
...
- Register a new user account and start using the coffee shop application.
